...
public class MedicalReportFragment extends Fragment {
    ...
    public MedicalReportFragment(String parentFolder) {
        // Required empty public constructor
    ...
    private void readMedical() {
        ...
        dbImages = FirebaseDatabase.getInstance().getReference().child("Medical");
    ...
    private void saveImage(){
        if(resultUri != null){
            filePath = FirebaseStorage.getInstance().getReference().child("Medical");
            Bitmap bitmap = null;
            try {
            ...
            Task<Uri> uriTask = uploadTask.continueWithTask(new Continuation<UploadTask.TaskSnapshot, Task<Uri>>() {
                ...
                public void onComplete(@NonNull Task<Uri> task) {
                    if(task.isSuccessful()){
                        ...
                        DatabaseReference db = FirebaseDatabase.getInstance().getReference().child("Medical");
