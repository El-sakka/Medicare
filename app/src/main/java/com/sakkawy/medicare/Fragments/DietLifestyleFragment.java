 ...
 */
public class DietLifestyleFragment extends Fragment {
    ...
    public DietLifestyleFragment() {
        // Required empty public constructor
    }


    public DietLifestyleFragment(String parentFolder) {
        // Required empty public constructor
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_diet_lifestyle, container, false);
    }
    ...
    private void readDietLifeStyle() {

        dbImages = FirebaseDatabase.getInstance().getReference().child("DietLifeStyle");
    ...
    private void saveImage(){
        if(resultUri != null){
            filePath = FirebaseStorage.getInstance().getReference().child("DietLifeStyle");
            Bitmap bitmap = null;
            try {
            ...
            Task<Uri> uriTask = uploadTask.continueWithTask(new Continuation<UploadTask.TaskSnapshot, Task<Uri>>() {
                ...
                public void onComplete(@NonNull Task<Uri> task) {
                    if(task.isSuccessful()){
                        ...
                        DatabaseReference db = FirebaseDatabase.getInstance().getReference().child("DietLifeStyle");
