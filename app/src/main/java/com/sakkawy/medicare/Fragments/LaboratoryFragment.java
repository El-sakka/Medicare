...
public class LaboratoryFragment extends Fragment {
    ...
    public LaboratoryFragment(String parentFolder) {
        // Required empty public constructor
    ...
    private void readLaboratory() {

        dbImages = FirebaseDatabase.getInstance().getReference().child("Laboratory");
    ...
    private void saveImage(){
        if(resultUri != null){
            filePath = FirebaseStorage.getInstance().getReference().child("Laboratory");
            Bitmap bitmap = null;
            try {
            ...
            Task<Uri> uriTask = uploadTask.continueWithTask(new Continuation<UploadTask.TaskSnapshot, Task<Uri>>() {
                ...
                public void onComplete(@NonNull Task<Uri> task) {
                    if(task.isSuccessful()){
                        ...
                        DatabaseReference db = FirebaseDatabase.getInstance().getReference().child("Laboratory");
